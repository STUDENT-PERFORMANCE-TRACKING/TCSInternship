...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------ -->
		...
		<div class="container-fluid" style="background-color:#FFFFFF; padding-bottom:191px; padding-top:40px;">
			<div class="col-md-8" style="padding-left:250px;">
				...
				<form action=createStudentResult method="get">
					...
					<table class="table table-borderless table-condensed table-hover">
						...
						<thead>
							<div >
								<h3><strong>Please fill new marks to their respective subject and click save button to save </strong></h3>
							</div>
						</thead>
					<s:iterator value="r" status="elemsStatus">
    					...
    					<s:textfield name="r[%{#elemsStatus.index}].ObtainedMarks" value="%{ObtainedMarks}" theme="simple"/>
      					...
      					<tr>
      						<td><s:property value="studentSubject"/></td>
    				<td>	<s:textfield name="r[%{#elemsStatus.index}].ObtainedMarks" value="%{ObtainedMarks}" theme="simple"/>    </td>     
      				    ...
      				    <s:hidden name="r[%{#elemsStatus.index}].studentSubject" value="%{studentSubject}" theme="simple"/>
   						...
   						<s:hidden name="r[%{#elemsStatus.index}].Semester" value="%{Semester}" theme="simple"/>
