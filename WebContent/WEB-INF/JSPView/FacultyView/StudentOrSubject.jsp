...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------ -->
		...
		<div class="container-fluid" style="background-color:#FFFFFF; padding-bottom:104px; padding-top:40px;">
			<div class="col-md-8" style="padding-left:250px;">
				
				<form action="wxyz" method="get">
					<div >
						<h4><strong>BRANCH : </strong></h4>
					</div>
					<select name="s.Student.BranchId" class="form-control">
					...
					<select name="s.Result.SemesterFirst" class="form-control">
					...
					<div >
						<h4><strong>Select student for particular student or subject for particular subject : </strong></h4>
					</div>	
